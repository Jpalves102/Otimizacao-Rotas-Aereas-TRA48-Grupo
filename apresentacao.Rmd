...
# Disponibilidade de aeronaves (AUMENTADO PARA COBRIR TODOS OS VOOS)
aircraft_availability <- c(A = 3, B = 1) # Agora temos 3 A + 1 B = 4 aeronaves, o suficiente para 4 voos
